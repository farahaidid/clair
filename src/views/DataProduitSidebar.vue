  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new" :settings="settings" :key="$vs.rtl">
      ...
      <div class="p-6">
        ...
        <span class="text-danger text-sm" v-show="errors.has('item-montant')">{{ errors.first('item-montant') }}</span>
        ...
        <span class="text-danger text-sm" v-show="errors.has('item-categorie')">{{ errors.first('item-categorie') }}</span>
  ...
  watch: {
    isSidebarActive(val) {
      ...
      if(!this.data) {
        ...
        let { id, nom, nomCli, montant, tva, categorie, date } = this.data
        this.employeeId = id
        this.dataNom = nom
