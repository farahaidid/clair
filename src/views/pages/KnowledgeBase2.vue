            ...
            faqs: [
                  {
                    id: 1,
                    categoryId: 2,
                    question: 'Quelles sont mes obligations comptables ?',
                    ans: "Deux documents comptables sont necessaires au micro-entrepreneur: un Livre des recettes et un Registre des achats (dans cas d'une activite de vente). Clair vous permet d'etablir ces deux documents de maniere mensuelle ou trimestrielle, en conformite avec la Loi."
                },
                {
                    id: 2,
                    categoryId: 2,
                    question: 'Mes factures sont-elles conformes ?',
                    ans: " Clair tient compte de la nouvelle legislation  (mise a jour le 1er octobre 2019) et propose des documents 100% conformes a la reglementation en vigueur. Les mentions legales obligatoires y sont automatiquement incorporees. Les factures et devis, une fois emis, ne peuvent plus etre modifies. "
                },
                {
                    id: 3,
                    categoryId: 2,
                    question: "Ais-je besoin d'un comptable pour m'aider a gerer Clair ?",
                    ans: "Non. Les documents crees par Clair suffisent a votre comptabilite. Nous proposerons bientot de remplir automatiquement vos declarations de Chiffre d'Affaires aupres de l'URSSAF. Vous pouvez cependant travailler avec un comptable si besoin. Clair genere automatiquement des lignes comptables, qu'il est possible d'exporter en un clic."
                },
                {
                    id: 4,
                    categoryId: 2,
                ...
                },
                {
                    id: 5,
                    categoryId: 3,
                    question: "Qu'en est-il de mes cotisations sociales ?",
