...
Il vous suffit de connecter vos comptes, vos documents seront importés automatiquement.
<br>
<br>
        <div class="vx-row">
          ...
          <div class="vx-col w-full sm:w-1/2 lg:w-1/3 mb-base">
                <vx-card>
                  ...
                  <div class="my-6">
                        ...
                        <vs-button href="./GmailConnect.vue" id="authorize-button" class="file-select" type="relief" color="#2F314B">Connecter Gmail</vs-button>
            ...
            <div class="vx-col w-full sm:w-1/2 lg:w-1/3 mb-base">
                <vx-card>
                    ...
                    <div class="my-6">
                        ...
                        <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 mr-2 shadow-lg" type="relief" color="#2F314B">Afficher Connexions</vs-button>
                    </div>
                </vx-card>
            </div>
