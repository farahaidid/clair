      ...
      <vx-card title="General"
        ...
        <div class="vx-row mb-6 scroll-area--data-list-add-new">
          <template v-if="formData.logo">
            <!-- Image Container -->
            <div
              class="img-container w-64 mx-auto"
            >
            ...
            <div class="modify-img flex justify-between mt-5">
              ...
              <vs-button
                ...
                >Editer</vs-button
              >
              <vs-button type="flat" color="#999" @click="formData.logo = null"
                >Supprimer</vs-button
              >
            </div>
            </div>
        ...
        <div class="vx-row">
          <div class="vx-col sm:w-2/3 w-full ml-auto">
            <vs-button class="mr-3 mb-2" @click="updateEntreprise"
